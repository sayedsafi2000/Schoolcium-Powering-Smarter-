...
export default function CTASection({
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-brand-700 via-brand-600 to-blue-700 py-20">
      {/* Decorative */}
      ...
      <div className="container-school relative text-center">
        <span className="inline-block bg-white/15 text-emerald-100 text-xs font-bold uppercase tracking-widest px-4 py-1.5 rounded-full mb-5">
          Enroll Today
        </span>
        ...
        <p className="mt-4 text-emerald-100 text-lg max-w-xl mx-auto leading-relaxed">{subtitle}</p>
        ...
        <a href="tel:01773763422"
          className="mt-5 inline-flex items-center gap-2 text-sm text-emerald-200 hover:text-white transition-colors font-medium">
